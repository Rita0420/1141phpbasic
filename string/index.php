...
$str=join("<span style='$style'>$keyword</span>",$str);
...
<p>美國總統川普（Donald Trump）的「對等關稅」政策再有新變化！美中雙方上週末在瑞士日內瓦舉行的貿易談判中達成共識，同意於5月14日前互降關稅90天。針對川普對等關稅政策出現急轉彎，是否意味著美中關稅戰徹底休兵？財訊傳媒董事長謝金河就發文點出川普談判策略出現重大轉折的原因，並以川普大作《交易的藝術》預測美中貿易戰略的關鍵4部曲。

美中兩國在台灣時間12日發表共同聲明，表示雙方達成互降關稅90天的共識，自14日起美國將暫把原對中國關稅從145％降至30％，而中國則是把對美課稅從125％降至10％，降幅高達115％。消息讓市場一片驚愕。謝金河12日就在臉書以「是驚嚇？還是驚喜？山不轉，川普先轉！」為題，解讀川普談判策略出現重大轉折的隱藏內幕。</p>
...
$keyword1="川普";
$keyword2="關稅";
$style1="font-size:1.2em;color:blue";
$style2="font-size:1.2em;color:red";

$str=str_replace("$keyword1","<span style='$style1'>$keyword1</span>",$str);
...
美中兩國在台灣時間12日發表共同聲明，表示雙方達成互降關稅90天的共識，自14日起美國將暫把原對中國關稅從145％降至30％，而中國則是把對美課稅從125％降至10％，降幅高達115％。消息讓市場一片驚愕。謝金河12日就在臉書以「是驚嚇？還是驚喜？山不轉，川普先轉！」為題，解讀川普談判策略出現重大轉折的隱藏內幕。";
$keywords=["川普","關稅"];
$styles=["font-size:1.2em;color:blue;text-decoration: none","font-size:1.2em;color:red"];
$a=["https://zh.wikipedia.org/zh-tw/%E5%94%90%E7%B4%8D%C2%B7%E5%B7%9D%E6%99%AE",
    "https://zh.wikipedia.org/wiki/%E5%85%B3%E7%A8%8E"];
foreach($keywords as $index => $keyword){
    $str=str_replace("$keyword","<a href='$a[$index]' style='$styles[$index]' >$keyword</a>",$str);
}
